<h2><a href="https://www.geeksforgeeks.org/problems/extract-maximum2943/1?page=2&category=Mathematics,Arrays,Matrix,Strings,Searching,Sorting,two-pointer-algorithm,Binary%20Search,Number%20Theory,Map,Set&difficulty=Basic&sortBy=submissions">Maximum Number in a String</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an alphanumeric string <strong>s</strong> consisting of lowercase letters (a–z), uppercase letters (A–Z), and digits (0–9).</span></p>
